...
#define LOG_WARN(fmt, ...) spdlog::warn("{:20}:{:<4}   | " fmt, __FILE__, __LINE__, ##__VA_ARGS__);
...
void init_logging(int argc, char* argv[]) {
    ...
    auto file_sink = std::make_shared<spdlog::sinks::basic_file_sink_mt>(CMAKE_LOG_DIR, true);
